...
st.markdown('> ##### ***Guide***: Select a mobile phone of your choice from the available options, and upon clicking the "Recommend" button, the model will promptly showcase the most closely related mobile phones based on your selection. The recommendation system leverages similarity metrics to identify and present the mobile phones with the highest resemblance to your chosen device, enabling you to explore alternatives that align with your preferences and requirements. \n > ##### *Note*: If you just click the Recommend button again without selecting any mobiles you will get to see new mobile phones in the Other Variety of mobiles section.')
st.markdown('')
st.markdown(' ')
...
st.markdown('---')
st.markdown('> #### Thank You for visiting :) \n Made by Samruddhi Nevse - 31458, Ojas Jain - 31459, Ninad Palsule - 31460')
